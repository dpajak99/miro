...
Future<void> main() async {
  ...
  final CosmosWalletAddress actualWalletAddress = CosmosWalletAddress(addressBytes: actualAddressBytes);

  // Expected values for tests
  final CosmosWalletAddress expectedWalletAddress = CosmosWalletAddress(addressBytes: actualAddressBytes);
  // @formatter:on
  ...
  group('Tests of WalletAddress.fromPublicKey() constructor', () {
    test('Should return correct WalletAddress from given public key bytes', () {
      expect(
        CosmosWalletAddress.fromPublicKey(actualPublicKeyBytes),
  ...
  group('Tests of WalletAddress.fromBech32() constructor', () {
    test('Should return correct WalletAddress from given bech32 address', () {
      expect(
        CosmosWalletAddress.fromBech32(actualBech32Address),
        expectedWalletAddress,
      );
    });
  });
