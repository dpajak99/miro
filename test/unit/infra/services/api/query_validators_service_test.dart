      ...
      PageData<ValidatorModel> expectedValidatorsPageData = PageData<ValidatorModel>(
        ...
        listItems: <ValidatorModel>[
          ValidatorModel(
            ...
            walletAddress: WalletAddress.fromAddress('kira1fffuhtsuc6qskp4tsy5ptjssshynacj462ptdy'),
          ...
          ValidatorModel(
            ...
            validatorStatus: ValidatorStatus.active,
            walletAddress: WalletAddress.fromAddress('kira1gfqq3kqn7tuhnpph4487d57c00dkptt3hefgkk'),
          ...
          ValidatorModel(
            ...
            validatorStatus: ValidatorStatus.active,
            walletAddress: WalletAddress.fromAddress('kira13hrpqkv53t82n2e72kfr3kuvvvr3565p234g3g'),
    ...
    test('Should return [List of ValidatorModel] if [server HEALTHY] and [response data VALID]', () async {
      ...
      List<ValidatorModel> expectedValidatorModels = <ValidatorModel>[
        ValidatorModel(
          top: 44,
          uptime: 98,
          walletAddress: WalletAddress.fromAddress('kira1vxvugjt7u0lpzgkpv5hr7qwu2v4rx64d597s3l'),
